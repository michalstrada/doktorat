%function [reschangedPositions, resMatrix] = algorytmzmniejszajacyICzzastowowaniemdjikstry(A_begin, changePercentage, changePossibilityThreshold)
function [reschangedPositions, resMatrix] = algorytmzmniejszajacyICzzastowowaniemdjikstry(A_begin)
    ...
    while k > k_min
        ...
        while (1 == 1)
            ...
            for(i = 1:1:size(changedPositionsIndexes, 2))
                A(pos_min_begin, changedPositionsIndexes(i)) = k*CalculateWeight(A, pos_max_begin, changedPositionsIndexes(i));
            ...
            if (size(posInChangedPositionIndexes, 2) == 0)
                ...
                A(pos_min_begin, pos) = k*CalculateWeight(A, pos_max_begin, pos);
